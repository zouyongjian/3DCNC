...
define("APP_ID","212432840000245270");  //应用ID
define("APP_SECRET","9306f96b592ee8c318282cb9dc7ea216");    //应用密钥
//得到accessToken
$data = "app_id=212432840000245270&app_secret=9306f96b592ee8c318282cb9dc7ea216&grant_type=client_credentials"; 
...
/*准备所有参数，进行排序，拼接*/
$param2 = $number.$student;
$name = "3D云课"; 
$template_id = "91548573";      //必选参数，短信模板ID
//$template_param = "{\"param1\":\"3D云课\",\"param2\":$number}"; //必选参数，模板匹配参数
$template_param = "{'param1':".$name.",'param2':".$param2."}";  //必选参数，模板匹配参数
